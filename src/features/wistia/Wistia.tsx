...
const Wistia = ({ viewVideosList }: any) => {
  ...
  return (
    <>
          ...
          <>
            ...
            {fileName !== '' && (
              <Tooltip
                content={
                  uploadActive
                    ? 'To edit the title, wait until the upload is complete.'
                    : 'Edit video name'
                }
              >
                <IconButton
      ...
      {!media && (
        <Box as="div" id="wistia_upload_drop_zone">
          <Flex
            as="div"
          ...
          >
            {!uploadActive && (
              <Stack spacing="spacingS" margin="spacingM">
                <Button id="wistia_upload_button" variant="primary">
                  Upload Video
                </Button>
                <Button variant="secondary" onClick={viewVideosList}>
                  Select Video
                </Button>
              </Stack>
            )}
            ...
            <Paragraph style={{ color: tokens.gray600 }}>
              {status ? status : 'Drag and drop a video file to upload...'}
            </Paragraph>
          </Flex>
        </Box>
      )}
