...
const ConfigScreen = () => {
  ...
  setup({
    ...
    name: 'Wistia Video',
    color: '#1e64f0',
    description: `The application connects with your Wistia account and allows to upload media or link already uploaded videos to your content in Contentful.
    ...
    parameterDefinitions: [
      {
        ...
        description:
          'Here comes the token from the Wistia dashboard -> Settings -> API Access. If you do not have access to Settings, you can request the Upload token from your administrator.',
        required: true,
      },
      {
        id: 'projectId',
        ...
        description:
          'Provide a valid Project ID to upload media to Wistia. You can find your Project ID in your Wistia account.',
        required: true,
      },
    ],
    validateParameters,
